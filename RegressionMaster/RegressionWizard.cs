...
{
    public class RegressionWizard
    {
        #region 多項式擬合函數,輸出係數是y=a0+a1*x+a2*x*x+.........，按a0,a1,a2輸出
        ...
        #region 一次擬合函數，y=a0+a1*x,輸出次序是a0,a1
        ...
        #region 一次擬合函數，截距為0，y=a0x,輸出次序是a0
        ...
        #region 二次擬合函數，y=a0+a1*x+a2x²,輸出次序是a0,a1,a2
        ...
        #region 對數擬合函數,.y= c*(ln x)+b,輸出為b,c
        ...
        #region 指數函數擬合函數模型，公式為 y=c*m^x;輸出為 c,m
